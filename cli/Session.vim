...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/seoul256.vim,~/.vim/plugged/goyo.vim,~/.vim/plugged/limelight.vim,~/.vim/plugged/SimpylFold,~/.vim/plugged/vim-zoom,~/.vim/plugged/lightline.vim,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set shiftwidth=4
set showbreak=>\ \ \\
set showmatch
...
silent only
silent tabonly
cd ~/development/einguteswerkzeug/cli
...
normal! 0
tabnext
edit einguteswerkzeug/shell/__init__.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
178
normal! zo
let s:l = 178 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
178
normal! 0
tabnext
edit einguteswerkzeug/core/__init__.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
set stal=1
badd +1 egw
badd +0 einguteswerkzeug/shell/__init__.py
badd +0 einguteswerkzeug/core/__init__.py
